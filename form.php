    ...
    <form action="index.php" id="my-formcarry" accept-charset="UTF-8" class="main" method="POST">
        ...
        <label>
            ...
            <div <?php if ($errors['abil']) {print 'class="error-abil"';} ?>> <select id="sp" name="superpower[]"
                                                                                      multiple="multiple">
                    <option <?php if($values['abil_value']=="1"){print 'selected';}?> value="fly">Полет</option>
                    <option <?php if($values['abil_value']=="1"){print 'selected';}?> value="immortality" >Бессмертие</option>
                    <option <?php if($values['abil_value']=="1"){print 'selected';}?> value="telepathy">Чтение мыслей</option>
                    <option <?php if($values['abil_value']=="1"){print 'selected';}?> value="telekinesis">Телекинез</option>
                    <option <?php if($values['abil_value']=="1"){print 'selected';}?> value="teleportation">Телепортация</option>
